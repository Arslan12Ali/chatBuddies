...
const ENDPOINT = "https://chatwithcolleagues.onrender.com/"; // If you are deploying the app, replace the value with "https://YOUR_DEPLOYED_APPLICATION_URL" then run "npm run build" to create a production build
